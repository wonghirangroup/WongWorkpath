      ...
      {target && (
        <motion.div key="delete-request-modal" className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <motion.div
            ...
            role="dialog" aria-modal="true" aria-label="ขอลบรายการ" className="relative bg-white rounded-2xl shadow-[0px_12px_36px_-8px_rgba(0,0,0,0.12)] w-full max-w-sm mx-4 overflow-hidden flex flex-col"
          >
